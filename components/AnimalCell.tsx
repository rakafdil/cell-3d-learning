...
const cellModels: PartInfo[] = [
  ...
  },
  {
    id: "lisosom",
    name: "Lisosom",
    description: "Lisosom adalah kantong bermembran tunggal yang mengandung enzim pencernaan. Berfungsi mencerna bagian sel yang rusak atau zat asing yang masuk ke dalam sel.",
    imagePath: "/img/animal_lysosome.png",
  },
  {
    id: "sentriol",
    name: "Sentriol / Sentrosom",
    description: "Sentriol adalah organel silinder kecil yang biasanya berpasangan (sentrosom) dan berperan penting dalam pembelahan sel dengan membentuk benang spindel, menentukan arah pembelahan, serta membantu pembentukan silia dan flagela.",
    imagePath: "/img/animal_centriole.png",
  },
  {
    id: "wadah",
    name: "Sitoplasma",
    description: "Sitoplasma adalah cairan tempat semua organel berada. Mengandung air, mineral, protein, dan berbagai senyawa lain untuk menunjang proses metabolisme sel.",
    imagePath: "/img/animal_cytoplasm.png",
  },
  {
    id: "membran",
    name: "Membran Sel",
    description: "Membran sel atau membran plasma bersifat semipermeabel, sehingga hanya zat tertentu yang dapat melewatinya. Berfungsi melindungi sel serta mengatur keluar masuknya zat.",
    imagePath: "/img/animal_cytoplasm.png",
  },
];
